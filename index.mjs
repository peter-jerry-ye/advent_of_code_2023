const importMeta = {
    url: "https://deno.land/x/wasm@v1.2.2/pkg/wasmer_wasi_js.js",
    main: false
};
let wasm;
...
class WASI {
    ...
    getImports(module1) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasi_getImports(retptr, this.ptr, addHeapObject(module1));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
function getImports() {
    ...
    imports.wbg.__wbg_get_19328b9e516e0330 = function() {
        return handleError(function(arg0, arg1) {
    ...
    imports.wbg.__wbg_getPrototypeOf_c046822345b14263 = function() {
    ...
    imports.wbg.__wbg_new_1c5d2ff1edfe6d73 = function() {
        return handleError(function(arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasmer_wasi_js_bg.wasm', importMeta.url);
    }
